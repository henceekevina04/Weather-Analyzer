...
## 1. Problem Statement
Many users need a quick, simple way to understand current local weather and get practical recommendations (dress, carry umbrella, stay indoors) without opening large apps or reading long forecasts. Students and casual users often want a lightweight tool that gives essential weather facts (temperature, humidity, wind) and a short actionable suggestion.
...
- Project report (PDF) upload to the portal as per VITyarthi instructions. 1
